...
Start with *Think Python, Direct AI* if you are a complete beginner, or jump into *Code Python, Consult AI* if you want a more focused approach to Python fundamentals. Both prepare you for the production-focused content in *Ship Python, Orchestrate AI*. For web development, start with *Build Web, Guide AI*. The methodology from *Converse Python, Partner AI* enhances all your development work.

**Conversation, Not Delegation** — the general methodology for working with AI across any discipline. Covers the Conversation Loop, the VET framework, and the principle of AI Last.

**Converse Python, Partner AI** (this book) — intentional prompting methodology applied to software development.

**Think Python, Direct AI** — computational thinking for absolute beginners. Learn to think like a programmer with AI as an exploration partner.

**Code Python, Consult AI** — focused Python fundamentals with AI integration.

**Ship Python, Orchestrate AI** — professional Python development practices with modern tools (uv, ruff, mypy, pytest).

**Build Web, Guide AI** — web development (HTML, CSS, JavaScript, WordPress, React) with AI as your development partner.
