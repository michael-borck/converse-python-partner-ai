...
|---|---|---|
| *Conversation, Not Delegation* | *Build Web, Guide AI*, or *Converse Python, Partner AI* (this book) | You want the ideas before (or without) code |
| *Think Python, Direct AI* | *Code Python, Consult AI*, then *Ship Python, Orchestrate AI* | You want to code from your first page |

*Converse Python, Partner AI* can be read alongside either path; its methodology enhances every one.
...
- **The Absolute Minimum You Must Know**: the free, always-current web companion at [minimum.borck.education](https://minimum.borck.education) — quick primers on every topic this series covers in depth.
